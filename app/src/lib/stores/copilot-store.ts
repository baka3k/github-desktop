...
import {
  ...
  type ICommitMessagePromptTags,
} from '../ai-summary/commit-message-prompt'
...
// The prompt primitives used to live in this file; they now live in the
// shared ai-summary module so every provider reads from a single copy.
export {
  buildCommitMessageSystemPrompt,
  buildCommitMessageUserPrompt,
  generateCommitMessagePromptTags,
