...
const DefaultDailyMeasures: IDailyMeasures = {
  ...
  aiSummaryGenerateCount: 0,
  aiSummaryGenerateErrorCount: 0,
  aiSummaryGenerateCancelledCount: 0,
  aiSummaryCopilotGenerateCount: 0,
  aiSummaryOpenAICompatGenerateCount: 0,
  aiSummaryExternalCLIGenerateCount: 0,
