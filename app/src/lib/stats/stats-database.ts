...
export interface IDailyMeasures {
  ...
  /** The number of AI summary generations that completed successfully */
  readonly aiSummaryGenerateCount: number

  /** The number of AI summary generations that failed */
  readonly aiSummaryGenerateErrorCount: number

  /** The number of AI summary generations that were cancelled by the user */
  readonly aiSummaryGenerateCancelledCount: number

  /** The number of successful AI summary generations via GitHub Copilot */
  readonly aiSummaryCopilotGenerateCount: number

  /** The number of successful AI summary generations via an OpenAI-compatible endpoint */
  readonly aiSummaryOpenAICompatGenerateCount: number

  /** The number of successful AI summary generations via an external CLI */
  readonly aiSummaryExternalCLIGenerateCount: number
